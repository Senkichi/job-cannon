...
**Plans**: 7 plans
Plans:
- [x] 22-01-PLAN.md -- Split ats_scanner.py into ats_detection.py + ats_prober.py + ats_scanner.py
...
- [x] 22-04-PLAN.md -- Split data_enricher.py into enrichment_tiers.py + company_enricher.py + data_enricher.py
- [x] 22-05-PLAN.md -- Split dashboard.py into batch_scoring.py + sync.py + dashboard.py blueprints
- [x] 22-06-PLAN.md -- Split profile.py into resume_review.py + profile_recommendations.py + profile.py blueprints
- [x] 22-07-PLAN.md -- Split pipeline_runner.py into scoring_runner.py + pipeline_runner.py
...
- [ ] 23-02-PLAN.md -- Batch archive in stale_detector.py
- [ ] 23-03-PLAN.md -- Pre-loop cancellation + deferred counters in batch_scoring.py
...
| 23. N+1 Batching | v1.4 | 1/3 | In Progress | - |
