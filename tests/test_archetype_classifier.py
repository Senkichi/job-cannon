...
class TestClassifyJobArchetype:
    ...
    def test_title_match_returns_archetype(self):
        ...
        result = classify_job_archetype(
            "Platform Engineer", "Build cloud infrastructure.", _CONFIG_WITH_ARCHETYPES,
        )
    ...
    def test_description_match_returns_archetype(self):
        from job_finder.web.archetype_classifier import classify_job_archetype
        result = classify_job_archetype(
            "Senior Engineer", "We need someone to build machine learning pipelines.",
            _CONFIG_WITH_ARCHETYPES,
        )
    ...
    def test_no_match_returns_none(self):
        from job_finder.web.archetype_classifier import classify_job_archetype
        result = classify_job_archetype(
            "Receptionist", "Greet visitors and answer phones.",
            _CONFIG_WITH_ARCHETYPES,
        )
    ...
    def test_case_insensitive_matching(self):
        from job_finder.web.archetype_classifier import classify_job_archetype
        result = classify_job_archetype(
            "PLATFORM ENGINEERING LEAD", "KUBERNETES DEPLOYMENT",
            _CONFIG_WITH_ARCHETYPES,
        )
        assert result == "platform_engineering"
    ...
    def test_first_match_wins(self):
        ...
        result = classify_job_archetype(
            "Platform Analytics Engineer", "Build platform with analytics.",
            _CONFIG_WITH_ARCHETYPES,
        )
        assert result == "platform_engineering"
    ...
    def test_word_boundary_matching(self):
        ...
        result = classify_job_archetype(
            "HTML Developer", "Build web pages with HTML.",
            _CONFIG_WITH_ARCHETYPES,
        )
