...
class TestScoreAndPersistJob:
    ...
    def test_legacy_functions_removed(self):
        ...
        Issue 154 removed _resolve_scoring_model (dead providers.scoring.model reader).
        """
...
class TestCascadeModelPersisted:
    ...
    providers.scoring.model. ScoringResult.model (set by the cascade) is the
    sole source of model attribution — these tests pin that behavior.
    """
