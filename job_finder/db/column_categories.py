...
COLUMN_CATEGORIES: dict[str, str] = {
    ...
    "salary_provenance": "parser",  # NEW in P1.5 m106 — trust-rank of the salary writer (D-4)
    "salary_observations": "parser",  # NEW in P1.5 m106 — lossless salary observation log (D-1)
    "description": "parser",
    "jd_full": "parser",
