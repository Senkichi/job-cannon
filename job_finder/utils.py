"""Shared utility functions for the job_finder package.

Contains pure helpers that are needed across both the persistence layer
(job_finder/db.py) and the web layer (job_finder/web/). Placing them here
keeps the import direction correct: persistence and web layers both depend
on this module, never on each other.
"""
