...
Uses the Groq API (https://api.groq.com/openai/v1/chat/completions).
OpenAI-compatible format with Bearer token authentication.

Example models: "llama-3.1-8b-instant", "llama-4-scout-17b-16e-instruct".
"""
...
class GroqProvider(BaseProvider):
    ...
    Args:
        config: Application config dict. Reads providers.groq.api_key_env
                (default: "GROQ_API_KEY") and providers.groq.base_url
    ...
    def call(
        ...
        """Make a chat completion call to Groq /v1/chat/completions.

        Schema is embedded in the system prompt. Groq supports
        ...
        Returns:
            ModelResult with provider="groq", schema_valid=True.
