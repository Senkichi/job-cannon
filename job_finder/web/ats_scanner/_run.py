"""ATS scan orchestrator + per-phase helpers.

run_ats_scan is the public entry; the underscore-prefixed helpers below
implement the five phases (A: ATS API, B: Homepage discovery, C: HTML
fallback, D: Scoring, E: Activity-feed log) that the orchestrator wires
together.
