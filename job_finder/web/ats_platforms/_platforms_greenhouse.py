...
def _posting_to_job(posting: dict, _slug: str) -> dict:
    ...
    # ── Title / URL via override-aware resolvers (C2 ATS alias override) ────
    # resolve_title/resolve_url consult the ATS alias override for "greenhouse"
    # first; with no override file the result is identical to the pre-C2 direct
    # extract_field call (canonical keys "title" / "absolute_url" first-match-wins).
